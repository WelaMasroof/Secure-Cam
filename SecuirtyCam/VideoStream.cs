    ...
    public partial class VideoStream : Form
    {
        ...
        private async void scriptcode()
        {
            ...
            try
            {
                ...
                string scriptPath = @"D:\SecuirtyCam\SecuirtyCam\Python\securitycam.py";
                string snapshotDirectory = @"D:\SecuirtyCam\SecuirtyCam\SecuirtyCam\bin\Debug\snapshots";
                ...
                ProcessStartInfo processStartInfo = new ProcessStartInfo()
                {
                    ...
                    CreateNoWindow = true,
                    WorkingDirectory = @"D:\SecuirtyCam\SecuirtyCam\SecuirtyCam\bin\Debug"
                };
